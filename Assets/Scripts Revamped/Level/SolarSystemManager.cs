...
public class SolarSystemManager {
    ...
    public void generateSystem()
    {
        ...
        planetDictionary = result;

    }

    //Create the sun (always centered)
    public GameObject generateSun(SystemSettings settings)
    {
        GameObject result;
    ...
    public GameObject generatePlanet(SystemSettings settings, float planetDistance)
    {
